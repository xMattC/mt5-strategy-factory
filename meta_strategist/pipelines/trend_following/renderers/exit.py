...
from meta_strategist.renderer_tools import build_input_lines, load_results_data
...
def render_exit(project_config: ProjectConfig, stage_config: StageConfig, indi_name: str, indi_data: dict) -> str:
    ...
    rendered_ea = stage_config.ea_template.render(
        ...
        exit_long_conditions=indi_data.get("exit_conditions", {}).get("long"),
        exit_short_conditions=indi_data.get("exit_conditions", {}).get("short"),
