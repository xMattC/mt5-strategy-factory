...
void trigger(int handle, bool& long_sig, bool& short_sig, int shift = 1) {

    long_sig = false; short_sig = false;
    int rsi_buff_index = 0; 
    double curr = m_utils.get_buffer_value(handle, rsi_buff_index, shift);
    double prev = m_utils.get_buffer_value(handle, rsi_buff_index, shift + 1);
