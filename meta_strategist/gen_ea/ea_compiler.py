...
def compile_ea(ea_mq5_path: Path) -> None:
    ...
    # Figure out the .mq5's path relative to MQL5 directory (required by MetaEditor)
    ...
    # Delete any previous .ex5 output before compiling to avoid confusion
    ...
    # Run MetaEditor as a subprocess (capture output for logging/debug)
